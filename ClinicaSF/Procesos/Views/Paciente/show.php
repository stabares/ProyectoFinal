<div class="container " style="margin-top:35px;">
    ...
    <form class="form-inline" action="?controller=paciente&action=search" method="post">
        ...
        <div class="form-group row">
            <div class="col-xs-4">
                <button type="submit" class="btn btn-primary"><span class="glyphicon glyphicon-search" style="margin:5px;"> </span> Buscar</button>
            </div>
        </div>
        <div class="form-group row">
            <div class="col-xs-4">
                <button type="submit" class="btn btn-primary" style="margin:5px;"> <a href="?controller=paciente&action=register"> Agregar Paciente </a> </button>
            </div>
        </div>
        
        <div class="form-group row">
            <div class="col-xs-4">
                <button type="submit" class="btn btn-primary" style="margin:5px;"> <a href="?controller=paciente&&action=show"> Ver </a> </button>
            </div>
        </div>
    </form>
