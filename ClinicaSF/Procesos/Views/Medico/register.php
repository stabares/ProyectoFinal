<div class="container">
    ...
    <form action="?controller=medico&&action=save" method="POST">
        ...
        <div class="form-group">
            <label for="text"></label>
            <input type="text" name="especialidad" id="especialidad"class="form-control" placeholder="Ingrese la Especilidad">
        </div>
